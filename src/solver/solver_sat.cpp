...
void Solver::sat(ColliderRow& a, ColliderRow& b, CollisionPair& pair) {
    ...
    getManifoldSoA()->getR()(pair.manifoldIndex + 0, 0, 0) = rA1.x * a.scale.x;
    getManifoldSoA()->getR()(pair.manifoldIndex + 0, 0, 1) = rA1.y * a.scale.y;
    getManifoldSoA()->getR()(pair.manifoldIndex + 0, 1, 0) = rA2.x * a.scale.x;
    getManifoldSoA()->getR()(pair.manifoldIndex + 0, 1, 1) = rA2.y * a.scale.y;
    ...
    // write contact points to manifold index
    getManifoldSoA()->getR()(pair.manifoldIndex + 1, 0, 0) = rB1.x * b.scale.x;
    getManifoldSoA()->getR()(pair.manifoldIndex + 1, 0, 1) = rB1.y * b.scale.y;
    getManifoldSoA()->getR()(pair.manifoldIndex + 1, 1, 0) = rB2.x * b.scale.x;
    getManifoldSoA()->getR()(pair.manifoldIndex + 1, 1, 1) = rB2.y * b.scale.y;
}
